...
<html>
	...
	<body background="resources/images/bizhi1.jpg" style=" background-repeat:no-repeat ;
...
background-attachment: fixed;" text-align:center >
		...
		<div class="content" style="margin-bottom: 100px; margin-top:5cm;margin-left:-1.5cm;">
						...
						<div class="lrform"  >
							...
							<div class="form">
								...
								<form class="form-horizontal" action="j_spring_security_check" method="post">
									<!-- Username -->
									<div class="form-group" style="margin-top:0.8cm;">
