						...
						<div class="page-content row">
							<form id="question-add-form" style="margin-top:40px;">
								...
								<div class="form-line question-knowledge">
									<span class="form-label"><span class="warning-label">*</span>科目类别：</span>
									<div>
										<div class="clearfix">
										...
										<div style="text-align:center;margin:10px 0;">
											<button id="add-point-btn" class="btn btn-success btn-xs">选择科目</button>
											<button id="del-point-btn" class="btn btn-danger btn-xs">删除科目</button>
											<button id="remove-all-point-btn" class="btn btn-warning btn-xs">清除科目</button>
										</div>
										<div  id="kn-selected" style="padding-left:0px;text-align:center;margin-bottom:20px;">
												...
												<p style="font-size:12px;color:#AAA;">请选择您的科目</p>
										</div>
									</div>
								...
								<div class="form-line question-content">
									...
									<span class="add-img add-content-img" style="width:100px;"></span>
									<span class="form-message"></span>
								</div>
								<div class="form-line form-question-opt" style="display: block;">
									...
									<div class="add-opt-items">
										...
										<span class="add-opt-item"><label class="que-opt-no">C</label>
											<input type="text" class="df-input-narrow form-question-opt-item">
											<span class="add-img add-opt-img"></span> <span><i class="small-icon ques-remove-opt fa fa-minus-square" title="删除此选项"></i></span>
										</span>
