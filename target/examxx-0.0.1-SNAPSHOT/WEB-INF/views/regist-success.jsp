...
<body background="resources/images/timg.jpg" style=" background-repeat:no-repeat ;
...
<div>
	...
	<div class="container" style="height:500px;margin-top: 280px; margin-left: 650px;">
		<h2>注册成功！</h2>
		<p class="big grey">
			您的账号为：<span>${username}</span>
		</p>
		<a href="user-login-page" class="btn btn-success"><i class="fa fa-sign-in"></i> 点击进入登录页面</a>
